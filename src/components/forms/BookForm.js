...
class BookForm extends Component {
  ...
  // need to use this because state is already set
  // When you change the book "onChange" then the data inside is not changed
    ...
    return (
      <Segment>
        <Form onSubmit={this.onSubmit} loading={loading}>
          <Grid fluid columns={2} stackable>
            <Grid.Row>
              <Grid.Column>
